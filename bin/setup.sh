...
apt-get -y install php$php-fpm php$php-common php$php-mbstring php$php-mysql php$php-xml php$php-zip php$php-bcmath php$php-imagick php$php-redis php-redis php$php-sqlite3 php$php-intl >> installer.log 2>&1
if [ $? -ne 0 ]; then
